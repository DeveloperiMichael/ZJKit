...
typedef NS_ENUM(NSInteger, ZJBetweenDatePickerMode) {
    ZJBetweenDateAndTimePickerMode = 0,
    ZJBetweenOnlyDatePickerMode,
    ZJBetweenOnlyTimePickerMode,
};
...
@protocol ZJSubBetweenDatePickerViewDelegate;


@interface ZJSubBetweenDatePickerView : UIView


@property(nonatomic, weak) id<ZJSubBetweenDatePickerViewDelegate> delegate;
...
@protocol ZJSubBetweenDatePickerViewDelegate <NSObject>
