...
@protocol ZJTimePickerViewDelegate;


@interface ZJTimePickerView : UIView


@property(nonatomic, weak) id<ZJTimePickerViewDelegate> delegate;
...
@protocol ZJTimePickerViewDelegate <NSObject>

@optional

// have selected date
- (void)zj_timePickerView:(ZJTimePickerView *)datePickerView didSelectTime:(NSDate *)selectTime;
