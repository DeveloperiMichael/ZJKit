...
@interface ZJAppDelegate ()<UNUserNotificationCenterDelegate>
...
//        self.window.rootViewController = [[SANavigationController alloc] initWithRootViewController:[[ZJViewController alloc] init]];
...
//    SANavigationController *homeNav = [[SANavigationController alloc] initWithRootViewController:[ZJViewController new]];
//    self.window.rootViewController = homeNav;
